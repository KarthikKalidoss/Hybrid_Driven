...
time.sleep(5)
select = wait.until(ec.visibility_of_element_located((By.XPATH, "//tbody/tr[1]/td[1]/input[1]"))).click()
select1 = wait.until(ec.visibility_of_element_located((By.XPATH, "//input[@id='aaValidValueModels_0__value1']")))
print(select1.text)
# for r in select1:
#     print(r.text)
